package org.wpwl.ac.schedule.web;
...
@WebServlet(name="schedule",urlPatterns="/cluster/schedule")
public class ManagerServlet extends HttpServlet{
	...
	private static final String UNCODE_SESSION_KEY = "cluster_key_session";
	...
	private static final String HEAD = 
		    ...
		    "\t  <meta name=\"description\" content=\"ClusterSchedule管理\"/>\n"+
	...
	private static final String PAGE_LOGIN_HTML_1 = 
			...
			"\t 			<div style=\"text-align:center;height:90px;margin:0 auto;\"><a href=\"#\"><img alt=\"uncode\" src=\"\" style=\"width:200px\"></a>schedule</div>\n"+
			"\t 		</li>\n"+
			"\t 		<li class=\"loginContLi\"> \n"+
...
//					response.sendRedirect(request.getSession().getServletContext().getContextPath()+"/cluster/schedule");
//				}
//			} catch (Exception e) {
//			}
...
//			out.write(PAGE_LOGIN_HTML_1 + request.getSession().getServletContext().getContextPath()+"/cluster/schedule" + PAGE_LOGIN_HTML_2);
//			if(!avilb){
//				out.write("\t <div>\n");
//				out.write("\t 用户名或密码错误!\n");
//				out.write("\t </div>\n");
			...
			try {
				...
				if(servers != null){
		    		...
		    		for(int i=0; i< tasks.size();i++){
		    		 ...
		    		 out.write(HEAD);
		    		 out.write(SCRIPT);
		    		 out.write(String.format(PAGE, request.getSession().getServletContext().getContextPath()+"/cluster/schedule", 
