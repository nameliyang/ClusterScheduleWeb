...
import org.wpwl.ac.schedule.core.IScheduleDataManager;
import org.wpwl.ac.schedule.core.ScheduleServer;
import org.wpwl.ac.schedule.core.ScheduledMethodRunnable;
import org.wpwl.ac.schedule.core.TaskDefine;
import org.wpwl.ac.schedule.zk.ScheduleDataManager4ZK;
import org.wpwl.ac.schedule.zk.ZKManager;


/**
 * 调度器核心管理
 */
public class ZKScheduleManager extends ThreadPoolTaskScheduler implements ApplicationContextAware,InitializingBean {
